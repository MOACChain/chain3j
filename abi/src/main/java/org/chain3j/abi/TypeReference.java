 ...
 * This is so that we can pass around Typed {@link org.chain3j.abi.datatypes.Array} types.
 *
 ...
 */
public abstract class TypeReference<T extends org.chain3j.abi.datatypes.Type>
    ...
    public static <T extends org.chain3j.abi.datatypes.Type> TypeReference<T> create(Class<T> cls) {
    ...
    public abstract static class StaticArrayTypeReference<T extends org.chain3j.abi.datatypes.Type>
