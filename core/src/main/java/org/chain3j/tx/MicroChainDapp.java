...
/**
 * MicroChain Dapp type abstraction for interacting with MicroChain 
 * deployed on SCSs as smart contracts via native Java types.
 * 
 */
@SuppressWarnings("WeakerAccess")
public abstract class MicroChainDapp extends ManagedTransaction {
    ...
    protected MicroChainDapp(String contractBinary, String contractAddress,
    ...
    public void setMicroChainAddress(String contractAddress) {
    ...
    public boolean isValid() throws IOException {
        if (contractAddress.equals("")) {
            throw new UnsupportedOperationException(
                    "Dapp binary not present, you will need to regenerate your "
                            + "Microchain Dapp wrapper with chain3j v0.2.0+");
        }

        // Get the code from the VNODE side?
     ...
     * Need to send this to the SCS side
     * 
     ...
     * This need to send to VNODE server with shardingFlag = 1
     * 
