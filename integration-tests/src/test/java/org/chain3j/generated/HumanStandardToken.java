...
public class HumanStandardToken extends Contract {
    ...
    public Observable<ApprovalEventResponse> approvalEventObservable(McFilter filter) {
        return chain3j.mcLogObservable(filter).map(new Func1<Log, ApprovalEventResponse>() {
            @Override
